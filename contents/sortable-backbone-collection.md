...
The two important functions here are `filterCollection()` and `resetFilter()`. The latter resets the collection by adding all originally contained models again.
